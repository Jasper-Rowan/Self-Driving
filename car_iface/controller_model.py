...
class Car_Interface():
    ...
    def __init__(self, model = "simple"):
        ...
        self.rolling_bias = 0.009923414741850902

        self.friction_constant = 0.10986552297998528



        self.accelerator_weight = 0.10005521497654903

        self.brake_weight = -0.24994518245095904
...
=======
        return os.path.join(cur_dir, "complex_accel")
>>>>>>> 3fabd2c31773a2593d64f64e3299df0c1e028875
